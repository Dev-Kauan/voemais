        ...
        <Pagina titulo="Voo">
            ...
            >
                {({
                    ...
                    //Máscara para data de embarque
                    values.data_embarque = mask(values.data_embarque, '99/99/9999');

                    //Máscara para data de checkin
                    values.data_checkin = mask(values.data_checkin, '99/99/9999');
